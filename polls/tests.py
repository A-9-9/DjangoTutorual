...
# Looked for test in polls
# created a special db for the purpose
# find the subclass of TestCase and looking for the function whose names begin with test
...
class QuestionIndexViewTests(TestCase):
    ...
    def test_two_past_question(self):
        question = create_question('Future question', days=-30)
        question2 = create_question('Future question', days=-5)
        response = self.client.get('polls:index')
        self.assertQuerysetEqual(
            response.context['latest_question_list'],
            [question2, question]
